...
public class HullModUtil {
    ...
    public static String getHullSizePercentString(Map<ShipAPI.HullSize, Float> map) {
        return CmcMisc.getDigitValue(map.get(ShipAPI.HullSize.FRIGATE)) + "%/" + CmcMisc.getDigitValue(map.get(ShipAPI.HullSize.DESTROYER)) + "%/" + CmcMisc.getDigitValue(map.get(ShipAPI.HullSize.CRUISER)) + "%/"
